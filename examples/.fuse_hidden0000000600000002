...
单独演示 fetch_fund 的调用方式，将返回的完整内容
以表格形式输出到终端。

Usage:
    cd astock-analysis
    pip install -e ".[dev]"
    python examples/fund_detail.py
"""
...
def pprint_fund(response: dict) -> None:
    """Pretty-print FundResponse."""
    data = response.get("data", [])

    print("=" * 120)
    print("  FundResponse 元信息")
    print("=" * 120)
